...
async def on_message(message):
    if message.author != client.user: # Check to make sure the bot can't trigger its own commands
        ...
        if message.content.startswith(prefix) or message.content.startswith(adminPrefix):
        ...
        elif message.content.startswith(prefix+'lmgtfy') or message.content.startswith(prefix+'LMGTFY'):
        ...
        #Only users inside the adminList can use the following commands
        elif message.content.startswith(adminPrefix) and message.author.id in adminList:
                #Command to shut down the bot
            if message.content.startswith(adminPrefix+'shutdown'):
            ...
            elif message.content.startswith(adminPrefix+'changeGame'):
            ...
            #User failed to authenticate (PUT ALL ADMIN COMMANDS BEFORE THIS ONE)
